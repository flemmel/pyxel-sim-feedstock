...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyxel-sim-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13050&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyxel-sim-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyxel-sim` can be installed with:

```
conda install pyxel-sim
```

It is possible to list all of the versions of `pyxel-sim` available on your platform with:
